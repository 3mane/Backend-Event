...
public class Application {
    ...
    CommandLineRunner start(AccountService accountService ){
        return args -> {
            ...
            accountService.addNewUser(new AppUser(null, "user1", "1234", new ArrayList<>(),new HashSet<>(),new ArrayList<>()));
            accountService.addNewUser(new AppUser(null,"admin","1234",new ArrayList<>(),new HashSet<>(),new ArrayList<>()));
